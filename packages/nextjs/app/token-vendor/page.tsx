...
const TokenVendor: NextPage = () => {
  ...
  // const { data: tokensToBuy } = useScaffoldReadContract({
  //   contractName: "Vendor",
  //   functionName: "tokensToBuy",
  // });
      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        ...
        {/* Buy Tokens */}
         <div className="flex flex-col items-center space-y-4 bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mt-8 w-full max-w-lg">
          ...
          <div>{tokensToBuy?.toString() || 0} tokens per ETH</div>
          ...
          <button
            ...
            onClick={async () => {
              try {
                await writeVendorAsync({ functionName: "buyTokens", value: getTokenPrice(tokensToBuy) });
              } catch (err) {
        ...
        {/* Sell Tokens */}
         {!!yourTokenBalance && (
          <div className="flex flex-col items-center space-y-4 bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mt-8 w-full max-w-lg">
            ...
            <div>{tokensToBuy?.toString() || 0} tokens to buy</div>
